    ...
    if user_data.get('verified', False):
        ...
        if step < len(story):
            ...
            if storyline[:5] == u'loc::':
                ...
                update.message.reply_photo(photo=parts[0], caption=parts[1], reply_markup=markup)
            else:
                update.message.reply_text(
                    storyline,
                    reply_markup=markup)
